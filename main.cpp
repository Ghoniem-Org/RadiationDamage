...
std::map<std::string, double> get_properties(int argc, char *argv[]) {
    ...
    // Example calculations (same as your original function)
    double T = 300; // Example temperature, should also be parsed
    double G = 1.0; // Example value, should be replaced with the actual logic
    double he_2_dpa = 1.0; // Example value, should be replaced with the actual logic
